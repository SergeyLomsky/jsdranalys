...
/**
 * Класс чтения бинарных данных из файла додетектоной записи формат данных
 * определяется перечислением CountdownType выходные данные представлены в
 * формате чисел с плавающей точкой для представления комплексных чисел
 * используется двумерный массив {{real,image},{real,image},...{real,image}}
...
public class SDRStreamEncoder {
     ...
     * 
     * @param len - количество отсчетов (комплексный отсчет представлен двумя
     *            числами)
